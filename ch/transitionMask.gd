...
@export var zoom_start: float = 0.0
@export var zoom_end: float = 2.0
...
@export var center_start: Vector2 = Vector2(0.5, 0.5)
...
@export var strength_start: float = 0.0
...
@export var duration_out: float = 2.0

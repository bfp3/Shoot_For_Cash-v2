...
#	$CircleBase.visible = true
#	$VanDialogue.playing = true
#
#func _on_van_dialogue_finished():
##	$CircleBase.visible = false
#	$intercomOff.play()
#
#
#func _on_magpie_1_timer_timeout():
#	$CircleBase.visible = true
#	$MagpieDialogue1.play()
#
#
#func _on_magpie_dialogue_1_finished():
##	$CircleBase.visible = false
#	$intercomOff.play()
